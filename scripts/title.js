...
$(document).ready(function(){
    ...
    var crsl = $(this);
    $('#title').html("~Welcome to Georgia: " + title[0] + "~"); 
    ...
    $('#mycarousel').on('slide.bs.carousel', function (){                     
        ...
        if(id == title.length){
            ...
            $('#title').html("~Welcome to Georgia: " + title[id] + "~");            
        }
    });  
    ...
    $('.carousel-control-prev').on('click',function(){
        ...
        if (id == 1){
            id = title.length;            
            $('#title').html("~Welcome to Georgia: " + title[title.length-1] + "~");           
        }else{
            id--;            
            $('#title').html("~Welcome to Georgia: " + title[id-1] + "~"); 
        }         
    }); 
